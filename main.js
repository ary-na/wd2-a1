...
function calculateTotalExpenses() {
    let expensesCatOneSubtotal = calculateSubtotalPerCat("expensesOne");
    let expensesCatTwoSubtotal = calculateSubtotalPerCat("expensesTwo");
    let expensesCatThreeSubtotal = calculateSubtotalPerCat("expensesThree");
...
function calculateSubtotalPerCat(category) {
    ...
    let expensesCat1 = document.querySelector(`#${category} #expensesThree`).value;
    let expensesCat2 = document.querySelector(`#${category} #expensesThree`).value;
    let expensesCat3 = document.querySelector(`#${category} #expensesThree`).value;
